...
const DataSiswa = ({ murids }) => {
    ...
    const handleSubmit = (e) => {
        ...
        router.post(route("guru.importSiswa"), {
            siswaList: soal,
        }, {
            headers: {
    ...
    const handleDownload = () => {
        const fileUrl = "/template/tambahSiswa.xlsx"; // URL ke file di public/
        const link = document.createElement("a");
        link.href = fileUrl;
        link.setAttribute("download", "templateSiswa.xlsx"); // Nama file saat didownload
        ...
        <AdminAuthenticatedLayout>
            ...
            {opsiTambahSoal == null && (
                ...
                <div className="flex flex-col gap-5 w-11/12">
                    ...
                    <p className="font-bold -mb-5">Akun Siswa</p>
                    <div className="flex justify-end gap-5">
                        <a href={route("guru.tambahSiswa")}>
