...
const EditUjian = ({ mapels, ujian }) => {


    const { data, setData, put, processing, errors, reset } = useForm({
        judul: ujian.data.judul || "",
        idMapel: ujian.data.idMapel || "",
        kelas: ujian.data.kelas || "",
        tahunAjaran: ujian.data.tahunAjaran || "",
        deskripsi: ujian.data.deskripsi || "",
        jamAwal: ujian.data.jamAwal || "",
        jamAkhir: ujian.data.jamAkhir || "",
    })
    ...
    const submit = (e) => {
        ...
        put(route('guru.updateUjian', ujian.data.idujian))
    }
