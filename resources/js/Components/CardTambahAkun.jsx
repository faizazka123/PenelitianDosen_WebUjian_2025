...
import FormNambahAkun from "./FormNambahAkun";
import Modal from "./Modal";
import { Icon } from "@iconify/react";

export default function CardTambahAkun({ idSoal }) {
    ...
    const handleDownload = () => {
        const fileUrl = "/template/template.xlsx"; // URL ke file di public/
        const link = document.createElement("a");
        link.href = fileUrl;
        link.setAttribute("download", "template.xlsx"); // Nama file saat didownload
    ...
    return (
        <div className="flex flex-col justify-center items-center gap-5">
            ...
            >
                ...
                {opsiTambahSoal == "manual" && <FormNambahAkun akun="siswa" />}
            </div>
